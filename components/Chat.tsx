  ...
  "
    ...
    >
      ...
      <div className="flex items-center justify-between pb-4 mb-4 border-b border-cyan-400/10">
        ...
        <button
          onClick={() => setMessages([])}
          className="text-xs px-3 py-1 rounded-lg bg-cyan-400/10 text-cyan-300 hover:bg-cyan-400/20 hover:text-cyan-200 transition duration-200 font-medium"
        >
          Limpiar
        </button>
      </div>
      ...
      <form
        ...
        className="flex items-center gap-3 pt-4 mt-4 border-t border-cyan-400/10"
      >
        <input
          type="text"
          value={input}
        ...
        <button
          ...
          className="
            ...
            bg-cyan-500 hover:bg-cyan-600 disabled:bg-gray-500 disabled:cursor-not-allowed
